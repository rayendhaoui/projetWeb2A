...
<form id="acceptForm" action="accept_blog.php" method="post">
                        <input type="hidden" name="article_id" value="<?php echo $post_id; ?>">
                        <input type="hidden" name="accepted" value="<?php echo $post['accepted']; ?>">
                        <button type="submit" name="accept" class="btn btn-<?php echo $post['accepted'] ? 'secondary' : 'success'; ?>">
                            <?php echo $post['accepted'] ? 'Unaccept' : 'Accept'; ?>
                        </button>
                    </form>
        <?php
    } else {
